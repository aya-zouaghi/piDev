...
public class AddSalleController {
    ...
    private Runnable onSalleAddedCallback;
    ...
    public void setOnSalleAddedCallback(Runnable callback) {
        this.onSalleAddedCallback = callback;
    }
    ...
    private void handleAddButton() {
        ...
        try {
            ...
            Salle salle = new Salle(
                    ...
                    currentUser.getIdUser(), // userId (utiliser l'ID de l'utilisateur connecté)
                    qualite, // qualite
                    prix // prix
            );
