package org.example.meniar.services;

import org.example.meniar.entities.Commentaire;
import org.example.meniar.utils.MyDatabase;
...
public class CommentaireService implements IService<Commentaire>{
    ...
    public void ajouter(Commentaire commentaire) throws SQLException {
        ...
        pst.setDate(2, new java.sql.Date(commentaire.getDatePublication().getTime()));  // Current date
