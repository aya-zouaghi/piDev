package org.example.eventcraft.entites;
...
public class Offre {
    ...
    private double rating; // Add the rating field


    // Constructor, getters and setters for the rating field
    ...
    public Offre(int idOffre, String titreOffre, String descriptionOffre, String typeOffre, float montant, java.util.Date dateExp, int evenement, Integer user, double rating) {
    ...
    // Constructor without idOffre (for new offers)
    public Offre(String titreOffre, String descriptionOffre, String typeOffre, float montant, java.util.Date dateExp, int evenement, Integer user, double rating) {
        this.titreOffre = titreOffre;
        this.descriptionOffre = descriptionOffre;
        this.typeOffre = typeOffre;
        this.montant = montant;
