...
public class DetailsDecoController {
    ...
    public void modifierDetails(ActionEvent actionEvent) {
        if (selectedDeco != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/ModifierDecoration.fxml"));
    ...
    public void AnnulerDetails(ActionEvent actionEvent) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/AfficherDecoration.fxml"));
            Parent root = loader.load();
    ...
    public void CommanderArticle(ActionEvent actionEvent) {
        if (selectedDeco != null) {
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/CommanderDeco.fxml"));
                Parent root = loader.load();
